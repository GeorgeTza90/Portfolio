...
export const CURRENT_DESKTOP_VERSION = import.meta.env.VITE_CURRENT_DESKTOP_VERSION;
...
if (!CURRENT_DESKTOP_VERSION) throw new Error("Missing VITE_CURRENT_DESKTOP_VERSION environment variable");