...
const LoudnessPresetButton = ({ heading, value, onChange, disabled = false }: LoudnessButtonProps) => {    
    const presets: { id: LoudnessPreset; label: string }[] = [
        { id: "quiet", label: "Quiet" },
        { id: "normal", label: "Normal" },
        { id: "loud", label: "Loud" },
    ];

    const activePosition: Record<LoudnessPreset, string> = {
        quiet: "0%",
        normal: "33.33%",
        loud: "66.66%",
    };
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={`${styles.extentionButton} ${disabled ? styles.off : styles.on}`}>
