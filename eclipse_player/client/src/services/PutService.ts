...
// -------------------- Playlists --------------------
export async function updatePlaylist(id: number, title: string, description: string) {
...
export async function moveSongInPlaylist(id: number, songId: number, newOrder: number) {    
...
// -------------------- Presets --------------------
export async function updatePreset(id: number, title: string, preset: [string]) {    
