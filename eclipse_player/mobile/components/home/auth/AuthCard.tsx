    ...
    return (
        <View style={styles.container}>
            <View style={styles.circleContainer}>
                <Circle size={435} shadowColor={shadowColor} intensity={intensity} />
            </View>

            <View style={styles.formContainer}>
                {!isLogin && (                    
                    <FormInput isForm={true} placeholder="Username" value={username} onChangeText={setUsername}/>
                )}
                
                <FormInput isForm={true} placeholder="Email" value={email} onChangeText={setEmail}/>
                ...
                <GoogleAuthButton title={"Login with Google"} loading={loading} width={260} onPress={() => {
                    // promptAsync();
                    setLocalError("Service not yet available!");
                }}/>

                <AuthButton loading={loading} isLogin={isLogin} onPress={onSubmit} width={260} />
...
const styles = StyleSheet.create({
    container: { flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 260, marginLeft: 0, marginBottom: -250 },
    circleContainer: { position: "absolute", top: -320, left: 0, right: 0, alignItems: "center", zIndex: 0 },
    formContainer: { top: -90, left: 0, zIndex: 1, width: 260 },
