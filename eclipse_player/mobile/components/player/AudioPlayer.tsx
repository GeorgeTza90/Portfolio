...
const styles = StyleSheet.create({
    ...
    buttonDiv: { flexDirection: "row", justifyContent: "space-around", width: width * 0.8, marginBottom: 40 },
    timeSliderContainer: { flexDirection: "row", alignItems: "center", width: width * 0.8, marginBottom: 30 },
    volumeSliderContainer: { flexDirection: "row", alignItems: "center", width: width * 0.65, marginBottom: 20, zIndex: 9 },
    time: { width: 40, textAlign: "center", color: "#fff" },
    volIcon: { width: 36, height: 36 },
