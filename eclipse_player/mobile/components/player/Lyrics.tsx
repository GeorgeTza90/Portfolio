...
const styles = StyleSheet.create({
    container: { position: "absolute", marginTop: 510,width: width, height: height * 0.365 },
    ...
    scrollContainer: { width: '100%', maxHeight: height * 0.5, backgroundColor: '#0000002d', borderRadius: 40 },
