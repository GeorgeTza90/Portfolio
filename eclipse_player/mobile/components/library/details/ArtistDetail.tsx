...
export default function ArtistDetail() {
    ...
    return (
        <LinearGradient colors={[ hexToRgba("#121212b2", 0.2), "#13131645" ]} style={styles.container}>
...
const styles = StyleSheet.create({
    ...
    artistImageBG: { position: "absolute", width: 500, height: 180, borderRadius: 12, zIndex: -1, top: 0, left: -22 },
