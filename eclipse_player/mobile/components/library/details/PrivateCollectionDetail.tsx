...
export default function PrivateCollectionDetail() {
    ...
    const averageColor = albumSongs[0].averageColor || "#0000007b";
    ...
    return (
        <LinearGradient colors={[ hexToRgba(averageColor, 0.2), "#13131645" ]} style={styles.container}>
...
const styles = StyleSheet.create({
    container: { flex: 1, borderRadius: 25, padding: 10, margin: 20 },
