  ...
  await knex("artists").insert([
    {
      ...
      name: "Neperia",
      description:
        "Neperia is a Greek Symphonic Metal band with all the attributes of the Symphonic Female-Fronted genre and many aspects of Death Metal sound. The band formed in 2008 at Ioannina city and in the next years performed a big number of lives as an opening act to many beloved bands and artists such as Paul Di'Anno, Firewind, Joe Lynn Turner, Ron Bumblefoot Thal, Innerwish, Jelusick and many more.",
      media: {
